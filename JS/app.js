...
// STEP 11
// How do arrow functions affect constructor functions? Constructor functions, automatically bind the "this" keyword to the newly created object, while arrow functions do not bind their own "this" context.
...
//// "this" refers to the "joe" object because the function is called as a method of the "joe" object. 

// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" refers to the global object (ex. window in a browser).

// 3. Explain why "this" is different when an arrow function is used.
// This is because in JavaScript, when a function is called as a method of an object, "this" inside the function refers to that object, while in an Arrow Function, they do not have their own "this" binding and instead inherit it from the enclosing lexical context.
